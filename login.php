...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "SELECT id, email, password, username, first_name, last_name FROM users WHERE email = '$email'";
                        ...
                        <div class="p-4">
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <input class="btn btn-primary w-100" type="submit" value="Account Login">
                                    </div><!-- .col -->
                                </div><!-- .row -->
                            </form>
                        </div><!-- .p-4 -->
