                        ...
                        <div class="col-lg-4">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Usecase Modals</li>
                                </ol>
                            </nav><!-- breadcrumb -->
                            <h1 class="display-6">Usecase Modals</h1>
                            <p>You get lot's of essential pre designed modal for you chat application.</p>
                        </div><!-- .col -->
                    </div><!-- .row -->
                </div><!-- .container -->
            </div><!-- .tyn-hero -->
            <div class="tyn-main tyn-modal-preview">
                <div class="tyn-section">
                    <div class="container-xl">
                        <div class="tyn-section-content">
                            <ul class="nav nav-tabs nav-tabs-line border-bottom-0 justify-content-center">
                                <li class="nav-item">
                                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#call-screens" type="button"> Call Screens </button>
                                </li><!-- li -->
                                <li class="nav-item">
                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#action-modal" type="button"> Action Modals </button>
                                </li><!-- li -->
                            </ul><!-- .nav -->
                            <div class="py-4">
                                <div class="tab-content">
                                    <div class="tab-pane show active" id="call-screens" tabindex="0">
                                        <div class="d-flex justify-content-center flex-wrap gap gap-3">
                                            <div class="px-3">
                                                <div class="modal fade show position-static d-block w-auto h-auto" tabindex="-1">
                                                    <div class="modal-dialog modal-dialog-centered modal-sm my-0">
                                                        <div class="modal-content border-0">
                                                            <div class="tyn-chat-call tyn-chat-call-video">
                                                                ...
                                                                <div class="tyn-chat-call-stack on-dark">
                                                                    <div class="tyn-media-group tyn-media-vr tyn-media-center mt-auto">
                                                                    ...
                                                                    <ul class="tyn-list-inline gap gap-3 mx-auto py-4 justify-content-center">
                                                                        <li><button class="btn btn-icon btn-pill btn-light">
                                                                        ...
                                                                        <li><button class="btn btn-icon btn-pill btn-danger">
                                                ...
                                                <h6 class="tyn-overline mt-3 text-center">Video Calling</h6>
                                            </div><!-- item -->
                                            <div class="px-3">
                                                <div class="modal fade show position-static d-block w-auto h-auto" tabindex="-1">
                                                    <div class="modal-dialog modal-dialog-centered modal-sm my-0">
                                                            ...
                                                            <div class="tyn-chat-call tyn-chat-call-video">
                                                                ...
                                                                <div class="tyn-chat-call-stack on-dark">
                                                                    <div class="tyn-media-group tyn-media-vr tyn-media-center mt-auto">
                                                                        ...
                                                                        <div class="tyn-media-col">
                                                                            <div class="tyn-media-row has-dot-sap">
                                                                                <span class="meta">VIdeo Call From ..</span>
                                                                            </div>
                                                                            <div class="tyn-media-row">
                                                                                <h6 class="name">Konstantin Frank</h6>
                                                                            </div>
                                                                    ...
                                                                    <ul class="tyn-list-inline gap gap-3 mx-auto py-4 justify-content-center">
                                                                        ...
                                                                        <li><button class="btn btn-icon btn-pill btn-success">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-camera-video-fill" viewBox="0 0 16 16">
                                                                                    <path fill-rule="evenodd" d="M0 5a2 2 0 0 1 2-2h7.5a2 2 0 0 1 1.983 1.738l3.11-1.382A1 1 0 0 1 16 4.269v7.462a1 1 0 0 1-1.406.913l-3.111-1.382A2 2 0 0 1 9.5 13H2a2 2 0 0 1-2-2z" />
                                                                                </svg><!-- camera-video-fill -->
                                                                            </button></li>
                                                ...
                                                <h6 class="tyn-overline mt-3 text-center">Incoming Video Call</h6>
                                            </div><!-- item -->
                                            <div class="px-3">
                                                <div class="modal fade show position-static d-block w-auto h-auto" tabindex="-1">
                                                    <div class="modal-dialog modal-dialog-centered modal-sm my-0">
                                                ...
                                                <h6 class="tyn-overline mt-3 text-center">On Going Video Call</h6>
                                            </div><!-- item -->
                                            <div class="px-3">
                                                <div class="modal fade show position-static d-block w-auto h-auto" tabindex="-1">
                                                    <div class="modal-dialog modal-dialog-centered modal-sm my-0">
                                                        <div class="modal-content border-0">
                                                            <div class="tyn-chat-call">
                                                                ...
                                                                <ul class="tyn-list-inline gap gap-3 m-auto py-4">
                                                                    <li><button class="btn btn-light"> <span>Switch To</span>
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-camera-video-fill" viewBox="0 0 16 16">
                                                                                <path fill-rule="evenodd" d="M0 5a2 2 0 0 1 2-2h7.5a2 2 0 0 1 1.983 1.738l3.11-1.382A1 1 0 0 1 16 4.269v7.462a1 1 0 0 1-1.406.913l-3.111-1.382A2 2 0 0 1 9.5 13H2a2 2 0 0 1-2-2z" />
                                                                            </svg><!-- camera-video-fill -->
                                                                        </button></li>
                                                ...
                                                <h6 class="tyn-overline mt-3 text-center">Audio Calling</h6>
                                            </div><!-- .item -->
                                            <div class="px-3">
                                                <div class="modal fade show position-static d-block w-auto h-auto" tabindex="-1">
                                                    <div class="modal-dialog modal-dialog-centered modal-sm my-0">
                                                        <div class="modal-content border-0">
                                                            <div class="tyn-chat-call">
                                                                ...
                                                                <div class="tyn-media-group tyn-media-vr tyn-media-center mt-n4 pb-4">
                                                                    ...
                                                                    <div class="tyn-media-col">
                                                                        <div class="tyn-media-row has-dot-sap">
                                                                            <span class="meta">Audio Call From ...</span>
                                                                        </div>
                                                                        <div class="tyn-media-row">
                                                                ...
                                                                <ul class="tyn-list-inline gap gap-3 m-auto py-4">
                                                                    <li><button class="btn btn-light"> <span>Ask For</span>
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-camera-video-fill" viewBox="0 0 16 16">
                                                                                <path fill-rule="evenodd" d="M0 5a2 2 0 0 1 2-2h7.5a2 2 0 0 1 1.983 1.738l3.11-1.382A1 1 0 0 1 16 4.269v7.462a1 1 0 0 1-1.406.913l-3.111-1.382A2 2 0 0 1 9.5 13H2a2 2 0 0 1-2-2z" />
                                                                            </svg><!-- camera-video-fill -->
                                                                        </button></li>
                                                ...
                                                <h6 class="tyn-overline mt-3 text-center">Incoming Call</h6>
                                            </div><!-- .item -->
                                            <div class="px-3">
                                                <div class="modal fade show position-static d-block w-auto h-auto" tabindex="-1">
                                                    <div class="modal-dialog modal-dialog-centered modal-sm my-0">
                                                ...
                                                <h6 class="tyn-overline mt-3 text-center">On Going Call</h6>
                                            </div><!-- .item -->
                                        </div><!-- .d-flex -->
                                    </div><!-- .tab-pane -->
                                    <div class="tab-pane" id="action-modal" tabindex="0">
                                        <div class="d-flex justify-content-center pt-3  flex-xl-nowrap flex-wrap gap gap-3 overflow-hidden">
                                            <div class="px-3">
                                                <div class="modal fade show position-static d-block w-auto h-auto overflow-visible" tabindex="-1" id="newChat">
                                                    <div class="modal-dialog modal-dialog-centered modal-sm my-0">
                                                        <div class="modal-content border-0">
                                                            <div class="modal-body p-4">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-solid" id="search" placeholder="Search contact">
                                                                    </div>
                                                                </div><!-- .form-group -->
                                            ...
                                            <div class="px-3">
                                                <div class="modal fade show position-static d-block w-auto h-auto overflow-visible" tabindex="-1" id="muteOptions">
                                                    <div class="modal-dialog modal-dialog-centered modal-sm my-0">
                                                        <div class="modal-content border-0">
                                                            <div class="modal-body p-4">
                                            ...
                                            <div class="px-3">
                                                <div class="modal fade show position-static d-block w-auto h-auto overflow-visible" tabindex="-1" id="deleteChat">
                                                    <div class="modal-dialog modal-dialog-centered modal-sm my-0">
                                                        <div class="modal-content border-0">
...
<!-- Mirrored from connectme-html.themeyn.com/ui-usecase-modals.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Oct 2024 19:34:29 GMT -->
</html>